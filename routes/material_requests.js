...
router.get('/', isAuthenticated, async (req, res) => {
    try {
        ...
        // Fetch projects and materials for the request form
...
// POST /material-requests/:id/status (PM only)
router.post('/:id/status', isAuthenticated, hasRole('SuperAdmin', 'Project Manager'), async (req, res) => {

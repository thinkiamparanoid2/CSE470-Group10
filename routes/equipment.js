...
// GET /equipment - Equipment Inventory & Maintenance Scheduler Dashboard (Member D)
...
// GET /equipment/create - Form to Register New Machinery
...
// POST /equipment/create - Register Equipment Action
...
// GET /equipment/schedule - Form to Schedule Maintenance Check-up
router.get('/schedule', isAuthenticated, hasRole('SuperAdmin', 'Project Manager', 'Site Engineer'), async (req, res) => {
    try {
...
// POST /equipment/schedule - Schedule Maintenance Action
router.post('/schedule', isAuthenticated, hasRole('SuperAdmin', 'Project Manager', 'Site Engineer'), async (req, res) => {
    ...
    try {
        ...
        // If scheduled immediately or in repair type, optionally transition equipment status
...
// POST /equipment/maintenance/:id/status - Update Maintenance & Machinery Status
router.post('/maintenance/:id/status', isAuthenticated, hasRole('SuperAdmin', 'Project Manager', 'Site Engineer'), async (req, res) => {

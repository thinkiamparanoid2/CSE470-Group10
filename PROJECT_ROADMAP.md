...
3. [ ] **Price Comparison Engine** *(Sprint 3)*
4. [ ] **Contract Document Upload** *(Sprint 4)*
...
3. [ ] **Project Progress Dashboard (Gantt-lite)** *(Sprint 3)*
...
4. [ ] **Emergency Material Request (Flagged Priority)** *(Sprint 3)*
...
- **Status:** ⏳ PENDING
- **Features to Build:**
  1. Project Progress Dashboard (Gantt-lite) *(Member C)*
  2. Price Comparison Engine *(Member B)*
  3. Emergency Material Request (Flagged priority) *(Member D)*
  4. Material Waste Log *(Member A)*
  5. Contract Document Upload *(Member B)*
